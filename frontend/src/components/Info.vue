<template>
    <b-card-group deck>
        ...
        <b-card header="Software stack">
            <p>Frontend:</p>
            <ul>
                <li>VueJS for logic</li>
                <li>Bootsrap for HTML/CSS</li>
            </ul>
            <p>Backend:</p>
            <ul>
                <li>Django</li>
        ...
        <b-card header="Contribute">
            <p>Should you have any suggestions, feature requests, bugs, report them to <strong>@Eugene Prodan</strong>.
            </p>
        </b-card>
    </b-card-group>
</template>
